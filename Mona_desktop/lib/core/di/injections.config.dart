...
import 'package:mona_desktop/features/auth/bloc/auth_bloc.dart' as _i15;
import 'package:mona_desktop/features/service/chat/chat_bloc.dart' as _i18;
import 'package:mona_desktop/features/service/chat/chat_service.dart' as _i13;
import 'package:mona_desktop/features/service/hub/hub_bloc.dart' as _i17;
import 'package:mona_desktop/features/service/hub/hub_service.dart' as _i14;
import 'package:mona_desktop/features/service/signalr_repository.dart' as _i12;
...
import 'package:mona_desktop/repository/repository_export.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i13.ChatService>(
        () => _i13.ChatService(repository: gh<_i12.SignalRRepository>()));
    gh.factory<_i14.HubService>(
        () => _i14.HubService(repository: gh<_i12.SignalRRepository>()));
    gh.lazySingleton<_i15.AuthBloc>(() => _i15.AuthBloc(
          gh<_i16.AbstractAuthRepository>(),
          gh<_i8.JwtService>(),
          gh<_i3.Talker>(),
        ));
    gh.factory<_i17.HubBloc>(() => _i17.HubBloc(
          gh<_i3.Talker>(),
          gh<_i14.HubService>(),
        ));
